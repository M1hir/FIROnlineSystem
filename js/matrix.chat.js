...
$(document).ready(function(){
	...
	setTimeout(function(){
			add_message('Constable Simran','img/demo/av2.jpg','Are there any new cases registered today')
		},'1000');
	setTimeout(function(){
			add_message('Officer Riya','img/demo/av3.jpg','Yes, There were over 5 FIRs lodged today!')
		},'4000');
	setTimeout(function(){
			add_message('Constable Simran','img/demo/av2.jpg','Alright! Better start working on it!')
		},'8000');
	setTimeout(function(){
			add_message('Officer Riya','img/demo/av3.jpg','ok Bye than!!!.')
		},'12000');	
	setTimeout(function(){
            remove_user('Constable Simran','Constable Simran')
        },'16000');
   	var i = 0;
